...
--
-- Database: `2026_ujikom_12rpl1_junaedi`
--
...
--
-- Table structure for table `laporken`
--

CREATE TABLE `laporken` (
  `nis` int(50) NOT NULL,
...
--
-- Dumping data for table `laporken`
--

INSERT INTO `laporken` (`nis`, `nama`, `kategori`, `lokasi`, `keterangan`, `feedback`, `status`) VALUES
(1, 'dew', 0, 'rwrw', 'rwrw', NULL, 'Belum Diproses');
...
(20, NULL, 'siswa', NULL, NULL, '12345', 'user'),
(21, NULL, 'admin', NULL, NULL, '12345', 'admin');
...
--
-- Indexes for table `laporken`
--
ALTER TABLE `laporken`
  ADD PRIMARY KEY (`nis`);
